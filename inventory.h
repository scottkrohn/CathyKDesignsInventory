...
public:
	// Constructors
	Inventory():filename("inventory.txt") {/*loadInventory();*/};	// Default constructor, inventory starts empty.
	Inventory(const std::string &fname): filename(fname) {loadInventory();}
